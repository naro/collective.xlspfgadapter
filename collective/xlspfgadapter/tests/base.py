...
# Set up the Plone site used for the test fixture. The PRODUCTS are the
# products to install in the Plone site (as opposed to the products
# defined above, which are all products available to Zope in the test
# fixture)
PRODUCTS = [
            'PloneFormGen',
...
def setup_product():
    ...
    import collective.documentpfgadapter
    zcml.load_config('configure.zcml', collective.documentpfgadapter)
    ...
    ztc.installPackage('collective.documentpfgadapter')
